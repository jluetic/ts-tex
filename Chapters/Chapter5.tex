...
Properties of the bottom quark, like relatively large mass and long lifetime, can be used to identify hadronic jets originating from b quarks. Such jets are originating from secondary interaction point with significant impact parameter, and $p_T$ of the jet constituents is harder than for light jets.  
